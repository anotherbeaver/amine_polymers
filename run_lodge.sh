...
for index in "${!patch_strength_list[@]}"; do
  ...
  mpirun -n 8 ${LAMMPS} -in "${INPUTEQ}" \
      ...
      -var molecule_file "data/polymer_chainlength_${N}_patchspacing_${patch_spacing}_N_beads_${N_beads}_gaussA_${patch_strength}_r0_0.25_gaussB_10_seed_${random_seed}_arrayid_${index}.molecule"
