...
#SBATCH --output=logs/lifetime_N_30_sticky_polymer_%A_%a.out
#SBATCH --error=logs/lifetime_N_30_sticky_polymer_%A_%a.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=azhu13@student.ubc.ca

# this file is for getting lifetimes and regime times
...
INPUTLIFETIME=in.polymers_lifetime
LOGDIR=logs
DATADIR=data
DUMPSDIR=data/dumps
...
random_seed=${random_0eed_list[0]}
...
printf "LIFETIME: %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" \
